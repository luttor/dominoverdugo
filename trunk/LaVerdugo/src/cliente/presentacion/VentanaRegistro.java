...
private String ruta= "/src/Imagen/";
    ...
    private void initComponents() {
        ...
        setTitle("No Eres Parte de Nosotros? Registrate Ya!");
    ...
    private void jbAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbAceptarActionPerformed
            ...
            if(!(jtfNombre.getText().equals("") || jtfApellido.getText().equals("") || jpfPassword.getText().toString().equals("")))
            {
                ...
                String resultado = new SimpleDateFormat("dd/MM/yy").format(jDateChooser1.getDate());
                System.out.println("resultado de la conversion de la fecha es " + resultado);
                System.out.println(jtfNickname.getText()+jpfPassword.getText()+jtfNombre.getText()+ jtfApellido.getText()+ resultado+ avatar);
                if (Comunicacion.RegistrarUsuario(jtfNickname.getText(), jpfPassword.getText(), jtfNombre.getText(), jtfApellido.getText(), resultado, avatar))
                        {
                            ...
                            JOptionPane.showMessageDialog(null,"Nombre de Usuario Ya sta en USO","Error",JOptionPane.ERROR_MESSAGE);
                        }
            }
